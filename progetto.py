...
def quiz_difficile():
    global mappa_quiz, risposta, volte, punteggio, corretta, valore_max, regioni, t
    regioni_province = random.randint(0,1)
    ...
    if t == 0:
        return render_template("quiz_difficile.html", opzione1 = opz1, opzione2 = opz2, opzione3 = opz3, opzione4 = opz4, score = punteggio, text = testo, tempo = t)
